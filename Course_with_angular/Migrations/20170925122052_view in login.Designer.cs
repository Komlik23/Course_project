...
namespace Course_with_angular.Migrations
{
    ...
    [Migration("20170925122052_view in login")]
    partial class viewinlogin
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Course_with_angular.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Course_with_angular.Models.Cookies_Model", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Course_with_angular.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
